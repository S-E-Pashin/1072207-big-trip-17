// Файл- точка входа для js. Место запуска рендера для элеметов на странице. Включает в себе ипорт/ссылки на файлы-функции, заключает их в переменные и запускает функцию.
